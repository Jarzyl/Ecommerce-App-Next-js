...
export default function Order() {
    ...
    return (
      ...
      <Layout>
        {isLoading ? (
          <div className="grid justify-center text-center mx-auto text-xl mt-32">Loading...</div>
        ) : !order ? (
          <div className="grid justify-center text-center mx-auto text-xl mt-32">No order available.</div>
        ) : (
          <div className="grid w-[330px] md:w-[550px] h-full mx-auto border-2 border-gray-200 rounded-lg justify-center mt-16 font-medium p-2">
            <div className="grid justify-center text-center mx-auto">
              ...
              <h1 className="text-2xl text-gray-700 font-bold mt-3">Thanks for your order!</h1>
              <h2 className="text-sm text-gray-400 mt-3 mb-3">The order confirmation has been sent to {order.email}</h2>
              <hr className="w-[300px] md:w-[520px]" />
            </div>
            <div className="text-left mt-2">
              <p className="text-gray-700 font-semibold text-lg">Transaction Date</p>
              <p className="text-sm text-gray-400 mt-2 mb-2">{new Date(order.createdAt).toLocaleString()}</p>
              <hr className="w-[300px] md:w-[520px]" />
            </div>
            <div className="text-left mt-2">
