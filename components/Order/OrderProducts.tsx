    ...
    return (
        <>
            ...
            {products.map((products: Product) => (
                <div key={products._id} className="flex items-center justify-between mb-3">
                <div className="grid md:flex items-center">
                    <Image src={products.picture} alt="products photo" className="object-contain max-h-full max-w-full mr-3" width={70} height={50} />
