      ...
      <div className="relative max-w-xs md:max-w-2xl lg:max-w-4xl xl:max-w-6xl h-[350px] mx-auto mt-16 md:mt-48 mb-10 md:mb-20">
        ...
        <div className="absolute top-4 left-0 w-full h-full flex flex-col items-center justify-center">
          <div className="text-center text-black">
            <p className="text-2xl md:text-4xl xl:text-5xl font-bold">
              Subscribe and Earn 20% Off
            </p>
            <p className="text-base md:text-xl mt-4">
              Discover new arrivals and inspiration, plus get 20% off your
              <br /> first order on full-priced items.
            </p>
          </div>
