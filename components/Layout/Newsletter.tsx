    ...
    return (
      ...
      <div className='absolute top-4 left-0 w-full h-full flex flex-col items-center justify-center'>
        <div className='text-center text-black'>
          <p className='text-2xl md:text-4xl xl:text-5xl'>Subscribe and Earn 20% Off</p>
        ...
        <div className="grid gap-2 md:flex items-center mt-5 md:mt-10 text-xl">
          ...
          <button
            ...
            className="text-lg w-28 h-12 font-bold text-white bg-black rounded-lg hover:bg-blue-500 focus:outline-none mx-2">Subscribe!
          </button>
          </div>
        </div>
      </div>
