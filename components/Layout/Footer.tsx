...
export default function Footer () {
  ...
  const socialLinks = [
    { icon: <BsTwitter size={20} />, url: 'https://twitter.com/?lang=en', label: 'Twitter' },
    { icon: <BsFacebook size={20} />, url: 'https://www.facebook.com/', label: 'Facebook' },
    { icon: <BsInstagram size={20} />, url: 'https://www.instagram.com/', label: 'Instagram' },
    { icon: <AiOutlineMail size={20} />, url: 'mailto:e-shop@gmail.com', label: 'E-mail' },
  ];
    ...
    return (
      ...
      {socialLinks.map((link) => (<a key={link.url} href={link.url} target="_blank"
          rel="noopener noreferrer" className="mx-2 hover:scale-125 duration-300"
    ...
    <div className="px-10 pt-3 text-left">
      <div className="grid md:grid-cols-5 gap-5 md:gap-32">
        <div className="md:w-40 lg:w-56">
          <p className="mb-3 text-xl xl:text-2xl flex justify-center font-semibold md:justify-start text-black">E-Shop</p>
        ...
        <div className="text-slate-400 text-center md:text-left">
          ...
          <div className="text-slate-400 text-center md:text-left">
          <p className="mb-3 text-xl xl:text-2xl flex justify-center font-semibold md:justify-start text-black">Products
          </p>
          <div className="text-sm xl:text-lg ml-0 md:ml-1">
          <p className="mb-2">
