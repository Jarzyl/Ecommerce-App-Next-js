  ...
  return (
    <>
      <div className="grid lg:flex justify-center lg:justify-between mt-10 md:mt-32 xl:mt-40 max-w-[400px] md:max-w-3xl lg:max-w-4xl xl:max-w-6xl mx-auto mb-8 px-6 md:px-0">
        <p className="text-2xl md:text-3xl text-black text-left font-bold mb-3 lg:mb-0">
          Why
          <br /> Choose Us
        </p>
        <p className="text-xl text-gray-400 w-full md:w-[420px] mt-3 mb-3 md:mt-0 lg:mb-0">
        ...
        <div className="justify-center flex h-20 w-30">
          <div className=" w-44 h-24 bg-gray-200 rounded-full">
            <Image
              ...
              src={deliver}
              width={140}
              className="object-cover rounded-full mx-auto mt-2"
            />
          </div>
        </div>
      </div>
      ...
      <div className="grid lg:flex justify-center lg:justify-between max-w-[400px] md:max-w-3xl lg:max-w-4xl xl:max-w-7xl mx-auto">
        <div className="grid mt-6 mb-6">
          ...
          <div className="w-72">
            <p className="ml-24 text-gray-400 text-sm">
              ...
              on all our furniture piecies. Rest easy knowing that your
        ...
        <div className="grid mt-6 mb-6">
          ...
          <div className="w-72">
            <p className="ml-24 text-gray-400 text-sm">
              We believe that quality furniture and office accessorises should
              be accesible to everyone. That`s why we offer a wide range of
        ...
        <div className="grid mt-6 mb-6">
          ...
          <div className="w-72">
            <p className="ml-24 text-gray-400 text-sm">
              We really understand our customers, so we wiil free shipping cost
              to any location quickly and safely. Enjoy free shiping on all
              orders.
            </p>
          </div>
        </div>
