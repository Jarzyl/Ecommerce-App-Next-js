...
// import { ProductsContext} from "@/components/ProductsConxtext";
...
//   const [productsInfos, setProductsInfos] = useState<CheckoutProduct[]>([]);
...
//       .then((json: Product[]) => {
//         const checkoutProducts = json.map((product) => ({
//           ...product,
//           amount: selectedProducts.filter((id) => id === product._id).length,
//         }));
//         setProductsInfos(checkoutProducts);
//       });
//   }, [selectedProducts]);

//   function moreOfThisProduct(id: string): void {
//     setSelectedProducts((prev) => [...prev, id]);
//   }

//   function lessOfThisProduct(id: string): void {
